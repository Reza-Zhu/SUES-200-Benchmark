...
def detect_sift_HardNet(img, model, nfeats = 5000, dev=torch.device('cpu')):
...
if __name__ == '__main__':
    ...
    model = HardNet(True).to(torch.device('cpu')).eval()
    ...
    NFEATS = 5000
    kpts1, descs1, As1 = detect_sift_HardNet(img1, model, NFEATS, dev)
    kpts2, descs2, As2 = detect_sift_HardNet(img2, model, NFEATS, dev)
