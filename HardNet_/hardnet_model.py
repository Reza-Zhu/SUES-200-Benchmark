...
urls: Dict[str, str] = {}
urls["hardnet++"] = "https://ghproxy.com/https://github.com/DagnyT/hardnet/raw/master/pretrained/pretrained_all_datasets/HardNet++.pth"
urls["liberty_aug"] = "https://ghproxy.com/https://github.com/DagnyT/hardnet/raw/master/pretrained/train_liberty_with_aug/checkpoint_liberty_with_aug.pth"  # noqa pylint: disable
urls["hardnet8v2"] = "https://ghproxy.com/http://cmp.felk.cvut.cz/~mishkdmy/hardnet8v2.pt"  # pylint: disable
    ...
    def __init__(self, pretrained: bool = False) -> None:
        ...
        if pretrained:
            pretrained_dict = torch.hub.load_state_dict_from_url(
                urls['hardnet++'], map_location=lambda storage, loc: storage
            )
