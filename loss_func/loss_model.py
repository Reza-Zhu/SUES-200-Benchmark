...
class ClassBlock(nn.Module):
    def __init__(self, input_dim, class_num, drop_rate, num_bottleneck=512, return_feature=False):
...
class SEResNet_50(nn.Module):
    def __init__(self, classes, drop_rate, share_weight=False, return_feature=False):
        ...
        self.return_feature = return_feature
        self.classifier = ClassBlock(2048, classes, drop_rate, return_feature=self.return_feature)
