...
def extract_keypoints(img_path,model):
    ...
    # print(xys.shape,desc.shape,scores.shape)
    outpath = img_path + '.' + 'r2d2'
...
if __name__ == '__main__':
    ...
    # args = "--model models/r2d2_WASF_N16.pt --images imgs/brooklyn.png --top-k 5000"
    # extract_keypoints()
